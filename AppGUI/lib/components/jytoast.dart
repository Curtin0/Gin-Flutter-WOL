...
class ToastUtils {
  ...
  static Future showSuccess(
    ...
    Widget img = Image.asset("image/hint_successfully.png",
        width: _imgWH, fit: BoxFit.cover);
  ...
  static Future showError(
    ...
    Widget img =
        Image.asset("image/hint_cancel.png", width: _imgWH, fit: BoxFit.cover);
    return showImageText(context, msg: msg, image: img, closeTime: closeTime);
  }
  ...
  static Future showLikeCollect(
    ...
    Widget img = Image.asset(
      isLikeCollect ? "image/hint_like.png" : "image/hint_nolike.png",
      width: _imgWH,
      fit: BoxFit.cover,
    );
    return showImageText(context, msg: msg, image: img, closeTime: closeTime);
  ...
  static Future showAdd(
    ...
    Widget img = Image.asset(
        isCircle ? "image/hint_add1.png" : "image/hint_add.png",
        width: _imgWH,
        fit: BoxFit.cover);
    return showImageText(context, msg: msg, image: img, closeTime: closeTime);
  }
  ...
  Widget build(BuildContext context) {
    ...
    var widget = Material(
        ...
        child: Align(
            ...
            child: Container(
//              width: width,
              constraints: BoxConstraints(minWidth: width ?? 150),
